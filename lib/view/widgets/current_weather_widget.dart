...
Widget currentWeatherDetails(BuildContext context) {
  final cwProvider = Provider.of<GL_WD_ViewModel>(context);
...
Widget currentWeatherTemperature(BuildContext context) {
  final cwProvider = Provider.of<GL_WD_ViewModel>(context);
  return Row(
    mainAxisAlignment: MainAxisAlignment.spaceAround,
    children: [
